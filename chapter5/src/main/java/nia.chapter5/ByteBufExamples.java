...
//        ByteBufExamples bbe = new ByteBufExamples();
//        bbe.heapBuffer();
    ...
    public static void directBuffer() {
        ...
        // 检查ByteBuf是否由数组支撑，是则为堆缓冲区，否则为直接缓冲区
    ...
    /**
     * ByteBuffer.copy 是复制一个副本，产生了一个新的对象
     * byteBuf.slice 是原始数据的一个切片，不产生新的对象
     * Listing 5.3 Composite buffer pattern using ByteBuffer
     */
...
//        ByteBufAllocator allocator2 = ctx.alloc();
        ...
        byteBuf.refCnt(); // 引用计数器，若对象已释放，则会抛出异常

        // 输出二进制的16进制
        ByteBufUtil.hexDump("{}~".getBytes());
    }
